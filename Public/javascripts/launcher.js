$(document).ready(function() {
    ...
    function SettingsToString() {
        ...
        return "?sound=" + getCookie("sound", "false") + "&trans=" + getCookie("trans", "false") + "&chroma=" + getCookie("chroma", "false") + "&persistent=" + getCookie("persistent", "false") + "&bossheal=" + getCookie("bossheal", "false") + "&hptype=" + getCookie("hptype", "overkill") + "&hpmult=" + getCookie("hpmult", "1") + "&hpinit=" + getCookie("hpinit", "1000") + "&hpincr=" + getCookie("hpincr", "100") + "&hpamnt=" + getCookie("hpamnt", "1000");
    }
